...
public class PivotConstants {
    ...
    public static final double KPRight = 0.52; //0.25
    ...
    public static final double poseToIntake = 18.6; //18.6
    public static final double poseForAuto = 7; 
    public static final double upwardAuto = 3; 
}
