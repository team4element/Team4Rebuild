...
public class CombinedTapShootCorner extends SequentialCommandGroup {
  public CombinedTapShootCorner(Shooter shooter, Conveyor conveyor, Spinster spinster, Intake intake) {
    addCommands(
        new ShootNoEndCorner(shooter).withTimeout(0.25), 

        new ParallelCommandGroup(
            new Shoot(shooter, 100), 
